...
public class SelectReflectBehaviourNet {
	
	private static String fileName = "neuralNetSelectReflectBehaviour.eg";
	private static int NUM_INPUT_BITS = 4;
	private static int NUM_OUTPUT_BITS = 1;
	public static double INPUT[][] = { { 0.1, 0.15, 1.0, 0.02 }, { 0.1, 0.50, 1.0, 0.02 }, { 0.3, 0.15, 1.0, 0.02 }, { 0.5, 0.15, 1.0, 0.02 }, 
									   { 0.5, 0.50, 1.0, 0.02 }, { 0.7, 0.15, 1.0, 0.02 }, { 0.9, 0.15, 1.0, 0.02 }, { 0.9, 0.50, 1.0, 0.02 },
									   { 0.1, 0.15, 1.0, 0.06 }, { 0.1, 0.50, 1.0, 0.06 }, { 0.3, 0.15, 1.0, 0.06 }, { 0.5, 0.15, 1.0, 0.06 },
									   { 0.5, 0.50, 1.0, 0.06 }, { 0.7, 0.15, 1.0, 0.06 }, { 0.9, 0.15, 1.0, 0.06 }, { 0.9, 0.50, 1.0, 0.06 }};
	public static double IDEAL[][] = { { 0.10 }, { 0.10 }, { 0.10 }, { 0.10 }, { 0.11 }, { 0.11 }, { 0.11 }, { 0.11 },
									   { 0.11 }, { 0.11 }, { 0.11 }, { 0.11 }, { 0.10 }, { 0.10 }, { 0.10 }, { 0.10 }};
	
	static boolean ready_to_parse = false;
	
	public SelectReflectBehaviourNet() {
		createTrainingData();
	}
	...
	public static void testoutput(){
		...
		BasicNetwork net = (BasicNetwork) EncogDirectoryPersistence.loadObject(new File(fileName));
		double[] input1 =  { 0.1, 0.15, 1.0, 0.02};
		double[] input2 =  { 0.1, 0.50, 1.0, 0.02};
		double[] input3 =  { 0.3, 0.15, 1.0, 0.02};
		double[] input4 =  { 0.5, 0.15, 1.0, 0.02};
		double[] input5 =  { 0.5, 0.50, 1.0, 0.02};
		double[] input6 =  { 0.7, 0.15, 1.0, 0.02};
		double[] input7 =  { 0.9, 0.15, 1.0, 0.02};
		double[] input8 =  { 0.9, 0.50, 1.0, 0.02};
		double[] input9 =  { 0.1, 0.15, 1.0, 0.06};
		double[] input10 =  { 0.1, 0.50, 1.0, 0.06};
		double[] input11 =  { 0.3, 0.15, 1.0, 0.06};
		double[] input12 =  { 0.5, 0.15, 1.0, 0.06};
		double[] input13 =  { 0.5, 0.50, 1.0, 0.06};
		double[] input14 =  { 0.7, 0.15, 1.0, 0.06};
		double[] input15 =  { 0.9, 0.15, 1.0, 0.06};
		double[] input16 =  { 0.9, 0.50, 1.0, 0.06};
